		...
		<div class="card-body">
			...
			<form method="post" action="{{ route('karyawan.store') }}">
				...
				<div class="form-group row">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" placeholder="Nama karyawan" value="{{ old('nama') }}">
						@error('nama')
				...
				<div class="form-group row">
					...
					<div class="col-sm-3">
						<select class="form-control @error('jabatan') is-invalid @enderror" id="jabatan" name="jabatan">
							...
							<option value="DIREKTUR" @if(old('jabatan') == 'DIREKTUR') selected @endif>DIREKTUR</option>
							<option value="FINANCE" @if(old('jabatan') == 'FINANCE') selected @endif>FINANCE</option>
							<option value="STAFF" @if(old('jabatan') == 'STAFF') selected @endif>STAFF</option>
						</select>
						@error('jabatan')
                        <div class="invalid-feedback">
                            {{ $message }}
